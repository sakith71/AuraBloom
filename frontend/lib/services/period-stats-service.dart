...
class PeriodStatsService {
  ...
  Map<String, dynamic> _calculateStats(List<PeriodCycle> cycles) {
    if (cycles.isEmpty) {
      return {'meanPeriodLength': 0, 'meanCycleLength': 0};
    }
    ...
    double meanCycleLength =
        cycleCount > 0
            ? totalCycleLength / cycleCount
            : 28; // Default to 28 if no complete cycles
  ...
  Future<Map<String, dynamic>> updatePeriodStats(
    String userId, {
    int cycleLimit = 3,
  }) async {
