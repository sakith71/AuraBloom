...
class _ProfileHeaderState extends State<ProfileHeader> {
  ...
  void _showEditProfileDialog(BuildContext context) {
    ...
    final nameController = TextEditingController(text: currentUserModel?.name ?? '');
                ...
                Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      enabled: false, // Email changes require authentication, so disable it here
                      decoration: InputDecoration(
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                          borderSide: BorderSide(
                        ...
                        filled: true,
                        fillColor: Colors.grey.shade200, // Darker background to indicate disabled
                        contentPadding: const EdgeInsets.symmetric(
                          horizontal: 16,
                          vertical: 14,
                        ),
                      ...
                      child: ElevatedButton(
                        onPressed: isUpdating 
                          ...
                          : () async {
                            ...
                            try {
                              if (currentUserModel != null && _authService.currentUserId != null) {
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: const Color(0xFFE91E63), // Pink color matching AuraBloom theme
                          elevation: 0,
                        ),
                        child: isUpdating
                            ? const SizedBox(
